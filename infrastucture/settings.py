...
NSLS2CORE_MONGODB_URI = config('NSLS2CORE_MONGODB_URI', cast=Secret)
NSLS2CORE_LOCAL_TESTING_URI = config('NSLS2CORE_LOCAL_TESTING_URI', cast=str)

if TESTING:
    NSLS2CORE_MONGODB_URI = NSLS2CORE_LOCAL_TESTING_URI
